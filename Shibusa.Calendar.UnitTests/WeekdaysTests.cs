...
namespace Shibusa.Calendar.UnitTests
{
    public class WeekdaysTests
    {
        ...
        {
            DateTime date = new DateTime(2020, 1, 1); // Wednesday
        ...
        public void Count_StartBeforeEnd_NotInclusive_Counts()
        {
            ...
            DateTime date2 = new DateTime(2020, 1, 2);
        ...
        {
            DateTime date1 = new DateTime(2020, 1, 2);
        ...
        {
            DateTime date1 = new DateTime(2020, 1, 3);
            DateTime date2 = new DateTime(2020, 1, 6);
            int count = Weekdays.Count(date1, date2, true);
            Assert.Equal(2, count);
        }
        ...
        {
            DateTime date1 = new DateTime(2020, 1, 6);
            DateTime date2 = new DateTime(2020, 1, 3);
            int count = Weekdays.Count(date1, date2, true);
            Assert.Equal(-2, count);
        }
    }
